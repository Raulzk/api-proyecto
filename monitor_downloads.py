...
class DownloadHandler(FileSystemEventHandler):
    ...
    def process_file(self, file_path):
        try:
            ...
            response = requests.post(extract_url, json={'file_base64': file_base64}, timeout=60)
            ...
            if response.status_code == 200:
                ...
                predict_response = requests.post(predict_url, json={'features': feature_values}, timeout=60)
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Monitorea una carpeta para archivos .exe, extrae características y predice usando una API.")
